...
subtitle: <green>AMS Sectional, Savannah, 2026</green>
...
- As $\beta\to0$, the inverse limit group of direct limits $\lim_{S\subset X}\pi_k(\mathcal S(\mathcal R_\beta(S)))$ is isomorphic to $\pi_k(\mathcal R_\beta(X)).$
:::
...
- Is the apex condition also necessary for shadow project to be a homotopy eqivalance?
